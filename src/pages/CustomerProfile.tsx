        ...
        <head>
          ...
          <style>
            ...
            .amount { 
              font-size: 32px; 
              font-weight: bold; 
              color: ${customer && customer.totalDebt > 0 ? '#dc2626' : '#16a34a'}; 
              text-align: center;
              margin: 20px 0;
            }
            .info-row { 
        ...
        <body>
          ...
          <div class="customer-info">
            ...
            <div class="info-row">
              ...
              <span class="value">${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()}</span>
            </div>
            <div class="info-row">
              <span class="label">Status:</span> 
              <span class="value">${customer && customer.totalDebt > 0 ? 'Amount Due' : 'Fully Paid'}</span>
            </div>
            <div class="amount">₹${customer ? Math.abs(customer.totalDebt).toLocaleString() : '0'}</div>
          </div>
          <div class="footer">
            <p>Generated by Ruply - Customer Management System</p>
